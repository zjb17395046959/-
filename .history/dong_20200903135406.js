...
function Test(ele,options,width=200){
	...
	function s(){
		...
		console.log(box_width+'====大盒子的整体宽度');
		//一行显示多少个图片=整体宽度/每张图片的宽度
		var row_num=Math.floor((box_width/width));
		console.log(row_num+'====一行显示多少张图片')
		//图片之间的间隙或者是图片之间的间距
		var gay=Math.floor((box_width-(row_num*width))/(row_num+1));
		console.log(gay+'=====每个图片之间的间距');
